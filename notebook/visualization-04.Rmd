...
In this case we'd have to use geom_ribbion and force the y_min to 0. Here, we set the alpha level so we can see the overlap. There is still a challenge in deciphering all of the time series, in particular at the bottom, where there are many overlapping series.
